...
class RedisClient {
     ...
     * @return {Promise<any>} A Promise that resolves with the value associated with the key, or rejects with an error.
     */
    async get(key) {
     ...
     * @return {Promise<void>} A Promise that resolves when the key is successfully set, or rejects with an error.
     */
     ...
     * @return {Promise<void>} A Promise that resolves when the key is successfully deleted, or rejects with an error.
     */
    async del(key) {
        return new Promise((resolve, reject) => {
