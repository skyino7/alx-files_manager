...
class DBClient {
     ...
     *
     * @return {Promise<number|null>} The number of users, or null if the database connection is not established.
     */
    async nbUsers() {
        if (!this.db) {
            return null;
     ...
     *
     * @return {Promise<number|null>} The number of files, or null if the database connection is not established.
     */
    async nbFiles() {
        if (!this.db) {
            return null;
